...
class Config
{
    ...
    public function addContact()
    {
        ...
        if (is_array($contactoData['data'])) {
            ...
            $sql = "INSERT INTO `_cfg_contacto`(`whatsapp`, `telefono`, `email`, `domicilio`,`localidad`,`provincia`,`pais`) 
    ...
    public function addMarketing()
    {
        ...
        if (is_array($marketingData['data'])) {
            ...
            $sql = "INSERT INTO `_cfg_marketing`(`google_data_studio_id`, `google_analytics`, `hubspot`, `mailrelay`,`onesignal`,`facebook_pixel`) 
